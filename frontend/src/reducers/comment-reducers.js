...
// TODO this has a lot in common with the post-reducers, in fact it was copied from there. Maybe extract a reducer factory for flat-id-based states
// with optional sorting
const commentReducers = (state = {}, action) => {
    // console.log('commentReducers', state, action);
    switch (action.type) {
        case INIT_COMMENTS:// when comments have been fetched
            ...
            // flatten all comments into the state with their ID as a key, so we can update them directly
